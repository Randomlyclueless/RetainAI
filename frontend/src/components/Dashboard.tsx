...
const API_BASE = 'http://localhost:8000';
  ...
  const MetricCard = ({ icon: Icon, label, value, trend, trendUp }: any) => (
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricCard label="Model AUC" value={health?.auc || '0.92'} trend="0.01" trendUp icon={TrendingUp} />
        <MetricCard label="Daily Queries" value={health?.predictions_today || '1,248'} trend="18%" trendUp icon={Zap} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 glass-card h-[450px]">
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-xl font-bold">Churn Risk Trends</h3>
        ...
        <div className="glass-card flex flex-col">
          <h3 className="text-xl font-bold mb-8">Model Health Status</h3>
          <div className="flex-1 space-y-6">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-400">Production Version</span>
                <span className="font-mono text-gold">{health?.model_version || 'v1.4.2'}</span>
              </div>
              <div className="flex justify-between text-sm">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span>{health?.last_retrain || '2h ago'}</span>
              </div>
            </div>
            ...
            <div className="mt-auto glass-panel p-4 bg-gold/5 border-gold/20">
              <div className="flex items-start gap-3">
                ...
                <p className="text-xs leading-relaxed text-gray-300">
                  <span className="font-bold text-gold">Pro-Tip:</span> High tenure users are showing increased sensitivity to pricing changes in the last 48 hours.
                </p>
              </div>
            </div>
          </div>
